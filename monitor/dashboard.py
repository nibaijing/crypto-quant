...
def generate_dashboard_html(account: LiveAccount, 
    ...
    total_return = ((account.total_equity - 10000) / 10000 * 100) if account.total_equity else 0
...
<div class="container">
  ...
  <div class="metrics-grid">
    ...
    <div class="metric-card">
      ...
      <div class="metric-sub" style="color: #94A3B8">初始: $10,000</div>
    </div>
    
    <div class="metric-card">
      <div class="metric-label">📈 浮动盈亏</div>
      <div class="metric-value" style="color: {pnl_color}">{pnl_sign}${account.unrealized_pnl:,.2f}</div>
      <div class="metric-sub" style="color: {pnl_color}">{pnl_sign}{((account.unrealized_pnl/10000)*100):.2f}%</div>
    </div>
